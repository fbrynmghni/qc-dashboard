...
- `/inspections/new` — the input form (`src/components/inspection-form.tsx`, Client Component) submitting to the Server Action `createInspection` in `actions.ts`.
